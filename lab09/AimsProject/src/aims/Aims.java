...
public class Aims {
	public Order order;
	public List<Media> lstProducts;
	
	public Aims() {
		order = new Order();
		lstProducts = new ArrayList<Media>();
		...
		lstProducts.add(new DVD("B title", "B category", "B diretor", 2, 2, MediaId.DVD));
		lstProducts.add(new DVD("A title", "A category", "A director", 1, 1, MediaId.DVD));
		
		
//		Iterator iterator = lstProducts.iterator();
...
//		
//		
//		//Collections.sort((List)lstProducts);
//		
//		iterator = lstProducts.iterator();
//		System.out.println("---------------------------------------");
